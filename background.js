...
chrome.runtime.onMessage.addListener(function (request) {
    ...
    // let sentence = SwahiliParser.parseSentenceIntoSyllables(request.toSay);

    // meSpeak.speak("Msichana, mvulana na mwanamamke");
    // chrome.tts.speak(sentence,
    //     { rate: 0.8, onEvent: function (event) { }, lang: 'id' }, function () { });
